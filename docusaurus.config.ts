...
const config: Config = {
  ...
  customFields: {
    description:
      "Personal website of Russell Yan, a blog about anything that crosses my mind which I think could interest y'all.",
    mType: 'website',
    ...
    [
      'classic',
      {
        ...
        blog: {
          ...
          feedOptions: {
            type: 'all',
            copyright: `Copyright ©2016-present Russell Yan. Built with Docusaurus.`,
          },
          postsPerPage: 3,
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `<span style='font-size: 10px;'>Copyright ©2016-present Russell Yan. Built with Docusaurus.</span>`,
    },
    prism: {
